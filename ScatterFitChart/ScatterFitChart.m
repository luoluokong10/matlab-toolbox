  ...
  methods ( Access = protected )
      ...
      function setup( obj )
          ...
          obj.ScatterSeries = scatter( obj.Axes, NaN, NaN, ...
              "Marker", obj.parameters.Scatter.Marker, ...
              "CData", obj.parameters.Scatter.CData, ...
              "DisplayName", "Data" );
          hold( obj.Axes, "off" )

          % Create the line object for the best-fit line.
          obj.BestFitLine = line( obj.Axes, NaN, NaN, ...
              "LineWidth", obj.parameters.Line.LineWidth, ...
              "Color", obj.Axes.ColorOrder(2, :), ...
              "DisplayName", "Best-fit line" );

          % Annotate the axes and add the legend.
          xlabel( obj.Axes, obj.parameters.Axes.XLabel )
          ylabel( obj.Axes, obj.parameters.Axes.YLabel )
          title( obj.Axes, obj.parameters.Axes.Title )
          legend( obj.Axes )
      ...
      function loadParameters(obj)
        ...
        names_ = fieldnames(obj.parameters);
        for i = 1:length(names_)
            if isfield(obj.parameters.(names_{i}), 'Comments')
                obj.parameters.(names_{i}) = rmfield(obj.parameters.(names_{i}), 'Comments');
            end
        end
    end
